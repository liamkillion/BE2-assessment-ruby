...
The FreshPotatoes API service will be separate from their customer-facing web application.  In this repo, you'll find the code that will power their API: starter code and tests built with Ruby, Sinatra, ActiveRecord, and Faraday.

* Once you’ve cloned, install the ruby gems: `$ bundle install`
* Then, run your application:  `$ bundle exec rackup`
* To run integration tests, run: `$ bundle exec rake test`
...
As part of this project, you must use this API to access film review data.  The third-party API is documented [here](THIRD_PARTY_API.md).
